...
In a terminal, run as:
    ...
    $ python gridworld_learn_explore.py --multiagent false
...
from gym_pybullet_drones.Grid_world_fast_test.gridworld_gym_env import GridworldEnv
from gym_pybullet_drones.Grid_world_fast_test.gridworld_mdp import GridworldEnv
...
def run(algo=DEFAULT_ALGO, output_folder=DEFAULT_OUTPUT_FOLDER, gui=DEFAULT_GUI, plot=True, local=True, incentive_options=DEFAULT_INCENTIVE_OPTIONS):
    ...
    train_env = make_vec_env(ExploreAviary,
                                env_kwargs=dict(incentive_options=incentive_options),
                                n_envs=1,
                                seed=0
                                )
    eval_env = ExploreAviary(incentive_options=incentive_options)
